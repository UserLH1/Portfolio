    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        >
          ...
          and back-end. I&apos;m really into web design and enjoy turning ideas
          into beautiful, easy-to-use sites.
        </motion.p>
        <motion.h3
          variants={slideInFromLeft(0.8)}
          className="text-2xl text-gray-400 my-2 max-w-[600px]"
        >
          Check out my projects to see what I can do as a full stack developer!
        </motion.h3>
        <motion.a
