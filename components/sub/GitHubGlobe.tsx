...
export function GitHubGlobe() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto relative ">
      <div className="max-w-4xl mx-auto relative overflow-hidden md:h-[40rem] px-4">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
