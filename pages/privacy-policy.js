...
const PrivacyPolicy = () => {
  return (
    <>
      <Head>
        <title>Politica de Confidențialitate - HoratiuLazea.com</title>
      </Head>
      <main
        style={{
          padding: "2rem",
      ...
      >
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Horatiu Lazea Portfolio.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Horatiu Lazea Portfolio,
              accessible from{" "}
              <a
                href="https://horatiulazea.com/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://horatiulazea.com/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: web.app.testing1234@gmail.com</li>
        </ul>
      </main>
    </>
  );
